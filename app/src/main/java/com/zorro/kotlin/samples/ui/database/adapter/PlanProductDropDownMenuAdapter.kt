...
import com.zorro.kotlin.samples.bean.PlanProductData
 ...
 * 备注：筛选产品
 */
class PlanProductDropDownMenuAdapter(data: List<PlanProductData>) :
    BaseQuickAdapter<PlanProductData, BaseViewHolder>(R.layout.dropdown_list_item, data) {
    ...
    override fun convert(helper: BaseViewHolder, item: PlanProductData?) {
        item ?: return
