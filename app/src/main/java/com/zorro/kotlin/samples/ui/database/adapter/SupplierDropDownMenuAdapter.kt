 ...
 * 备注：筛选公司
 */
class SupplierDropDownMenuAdapter(data: List<SupplierData>) :
    BaseQuickAdapter<SupplierData, BaseViewHolder>(R.layout.dropdown_list_item, data) {
    ...
    override fun convert(helper: BaseViewHolder, item: SupplierData?) {
        item ?: return
