...
/**
 * Created by Zorro on 2019/11/12.
 * 备注：圆形进度环
 */
public class RingProgressView extends View {
    ...
    public RingProgressView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.RingProgressView, 0, 0);

        try {
            mBgColor = a.getColor(R.styleable.RingProgressView_bgColor, 0xffe1e1e1);
            ...
            mPercent = a.getFloat(R.styleable.RingProgressView_percent, 75);
            mStartAngle = a.getFloat(R.styleable.RingProgressView_startAngle, 0) + 270;
