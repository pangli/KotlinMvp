package com.zorro.kotlin.baselibs.http.cookies
...
class OkHttpCookies : Serializable {
    ...
    private fun readObject(stream: ObjectInputStream) {
        val name = stream.readObject() as String
        val value = stream.readObject() as String
        val expiresAt = stream.readLong()
        val domain = stream.readObject() as String
        val path = stream.readObject() as String
        val secure = stream.readBoolean()
        val httpOnly = stream.readBoolean()
        val hostOnly = stream.readBoolean()
